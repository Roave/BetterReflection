...
$method = \BetterReflection\Reflection\ReflectionMethod::createFromName('ReflectTestClass', 'twoArgFunction');
// Get the parameters
...
$method = \BetterReflection\Reflection\ReflectionMethod::createFromName('ReflectTestClass', 'oneArgNonStatic');
$parameters = $method->getParameters();
