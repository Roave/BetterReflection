...
function reflectMethodModifiers($class) {
    $classInfo = \BetterReflection\Reflection\ReflectionClass::createFromName($class);
...
$a = \BetterReflection\Reflection\ReflectionMethod::createFromName('TestClass::foo');
$a->getModifiers(1);

$a = \BetterReflection\Reflection\ReflectionMethod::createFromName('ReflectionMethod::getModifiers');
