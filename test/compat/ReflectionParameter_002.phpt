...
$method = \BetterReflection\Reflection\ReflectionMethod::createFromName('ReflectTestClass', 'staticMethod');
// Get the parameters
...
// Create an instance of the Reflection_Method class
$method = \BetterReflection\Reflection\ReflectionMethod::createFromName('ReflectTestClass', 'instanceMethod');
// Get the parameters
$parameters = $method->getParameters();
