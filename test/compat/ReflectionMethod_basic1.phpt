...
function reflectMethod($class, $method) {
    $methodInfo = \BetterReflection\Reflection\ReflectionMethod::createFromName($class, $method);
    echo "**********************************\n";
    echo "Reflecting on method $class::$method()\n\n";
    echo "\nisFinal():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isFinal());
    echo "\nisAbstract():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isAbstract());
    echo "\nisPublic():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isPublic());
    echo "\nisPrivate():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isPrivate());
    echo "\nisProtected():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isProtected());
    echo "\nisStatic():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isStatic());
    echo "\nisConstructor():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isConstructor());
    echo "\nisDestructor():\n";
    // @todo see https://github.com/Roave/BetterReflection/issues/155 --- var_dump($methodInfo->isDestructor());
    echo "\n**********************************\n";
}
