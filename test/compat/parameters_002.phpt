...
check_params(\BetterReflection\Reflection\ReflectionFunction::createFromName('test'));

check_params(\BetterReflection\Reflection\ReflectionMethod::createFromName('test::method'));
