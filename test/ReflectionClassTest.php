...
use Roave\ReflectionClass;
use Roave\ReflectionProperty;
use Roave\ReflectionMethod;
use Roave\Reflector;
...
class ReflectionClassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testClassNameMethodsWithNamespace()
    {
        ...
        $this->assertSame('RoaveTest\Fixture\ExampleClass', $classInfo->getName());
        $this->assertSame('RoaveTest\Fixture', $classInfo->getNamespaceName());
    ...
    {
        $class = 'RoaveTest\Fixture\ExampleClass';
